    ...
    <div className="min-h-screen bg-gray-100">
      <div className>
        ...
        <div className="bg-white p-5 shadow-sm space-y-4">
          ...
          {/* 든든 포인트 */}
          <div className="flex items-center justify-between bg-[#F6F9F9] rounded-2xl p-4 shadow-[0px_0px_10px_2px_rgba(0,0,0,0.03)] border border-emerald-200">
          ...
          <button
            onClick={goToReports}
            className="bg-gray-50 rounded-xl p-4 flex items-center justify-between w-full hover:bg-gray-100"
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-500">전문가와 함께 안전한 계약 해요</div>
                </div>
              </div>
              <span className="text-gray-400 text-xl">›</span>
            </button>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-500">무료로 견적 받아 보세요!</div>
                </div>
              </div>
              <span className="text-gray-400 text-xl">›</span>
            </button>
